...
import { activateFrontend, assertFrontendManifest, assertProductionConfig, assertSourceManifest, restoreFrontend, SOURCE_COMMIT, VERSION } from './guard.mjs';
...
async function preflight(materials) {
  ...
  run('httpd', ['-t']);
  const oldManifest = JSON.parse(read(OLD_RELEASE + '/frontend-manifest.json'));
